...
Route::group(['middleware'=> 'isadmin'], function(){
  ...
  Route::resource('/teacher/all_reports', 'AllReportController');
  Route::resource('/teacher/top_report', 'TopReportController');
  Route::resource('/teacher/topics', 'TopicController');
  Route::resource('/teacher/questions', 'QuestionsController');
  Route::post('/teacher/questions/import_questions', 'QuestionsController@importExcelToDB')->name('import_questions');
...
Route::post('search_exam','UsersController@search_exam')->name('search_exam');

Route::resource('/admin/users', 'UsersController');
Route::resource('/teacher/users', 'UsersController');
