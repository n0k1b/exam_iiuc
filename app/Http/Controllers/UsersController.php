...
class UsersController extends Controller
{
    ...
    {
        $users = User::where('role', '!=', 'A')->where('role', '!=', 'T')->get();
        return view('teacher.users.indexx', compact('users'));
    ...
    public function search_exam(Request $request)
    {
      ...
      {
        return redirect()->back()->with('error','Exam code not found');
      }
      //file_put_contents('test.txt',$unique_code);
    }
